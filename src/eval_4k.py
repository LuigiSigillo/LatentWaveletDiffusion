...
transformer = FluxTransformer2DModel.from_pretrained(bfl_repo, subfolder="transformer", cache_dir="/leonardo_scratch/large/userexternal/lsigillo")
pipe = FluxPipeline.from_pretrained(bfl_repo, transformer=transformer, torch_dtype=dtype,cache_dir="/leonardo_scratch/large/userexternal/lsigillo")
...
pipe.load_lora_weights("/leonardo_scratch/fast/IscrC_UniMod/luigi/HighResolutionWav/src/ckpt/urae_2k_adapter.safetensors")
pipe.fuse_lora()


# ckpt_path = "/leonardo_scratch/fast/IscrC_UniMod/luigi/HighResolutionWav/src/ckpt/4K_URAE_VAE_SE_WAV_ATT_AESTHETIC_4096/checkpoint-1000"
...
cache_path = None #'ckpt/_urae_4k_adapter_dev.safetensors'
